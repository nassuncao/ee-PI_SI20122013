...
namespace PI_MVC.Infrastructure
{
    public class MyMembershipProvider : MembershipProvider
    {
        ...
        {
            User curr = _userRepo.GetUser(username);
            return curr.ChangePassword(oldPassword, newPassword);
        }
        ...
        {
            return _userRepo.DeleteUser(_userRepo.GetUser(username));
        }
        ...
        {
           return _userRepo.ValidateUser(username, password)!=null;
        }
    }
}